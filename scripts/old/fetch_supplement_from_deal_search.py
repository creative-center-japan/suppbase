        ...
        for page in range(MAX_PAGES):
            ...
            for d in items:
                ...
                rows.append({
                    ...
                    "category": "supplement",
                    "sub_category": "bcaa",
                    "source": f"deal_search:bcaa:{keyword}",
                    "first_seen_at": now,
                    "last_seen_at": now,
                    "is_active": True,
                })
            ...
            if rows:
                ...
                print(f"[OK] registered {len(rows)} supplement ASINs")

            time.sleep(SLEEP_PER_CALL)

    print(f"[DONE] total registered supplement ASINs = {total_registered}")
